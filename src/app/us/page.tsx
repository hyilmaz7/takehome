...
export const metadata: Metadata = {
  title: 'US Salary Calculator 2025 — Federal & State Tax Calculator',
  description:
    'Calculate your US take-home pay after federal income tax, state tax, Social Security and Medicare. Free 2025 salary calculator covering all 50 states.',
...
export default function USPage() {
  return (
    <>
      <Hero
        eyebrow="United States · 2025 tax year"
        title="US Salary Calculator — your take-home pay after tax"
        subheading="See your net pay after federal income tax, state tax, Social Security and Medicare. Pick any of the 50 states for an accurate 2025 estimate."
        titleId="us-title"
      />
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="flex flex-col gap-4 text-sm leading-relaxed" style={{ color: 'var(--slate-600)' }}>
          <p>
            ...
            Medicare. Federal tax is progressive across seven 2025 brackets from 10% to 37%, applied
            to your income after the $15,000 standard deduction (single) and any pre-tax 401(k) or
          ...
          <p>
            ...
            calculator applies the correct 2025 rates for the state you select.
          </p>
          <p>
            FICA is a flat 7.65%: Social Security at 6.2% up to the $176,100 wage base, plus Medicare
